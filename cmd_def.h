...
#ifndef PACKSTRUCT
#ifdef PACKED
#define __pragma pack(push,1)a) a PACKED
#else
/*Default packed configuration*/
#ifdef __GNUC__
#ifdef _WIN32
#define __ragma pack(push,1) decl ) decl __attribute__((__packed__,gcc_struct))
#else
#define __pragma pack(push,1) decl ) decl __attribute__((__packed__))
#endif
#define ALIGNED __attribute__((aligned(0x4)))

#else //msvc

#define __pragma pack(push,1) decl ) __pragma( pack(push, 1) ) decl __pragma( pack(pop) )
#define ALIGNED
